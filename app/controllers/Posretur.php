...
class Posretur extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('posretur_model');
    ...
    function autocompletesales() {
        ...
        $rows = $this->posretur_model->getSales($term);
        if ($rows) {
            foreach ($rows as $row) {
    ...
    function index($sid = NULL, $eid = NULL) {
        ...
        else
        {
            ...
            */
            ...
            $this->load->view($this->theme.'posretur/index', $this->data, $meta);
        }
